...
export function IconTrophy({ className }) {
  return (
    <svg className={className} width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden="true">
      <path d="M6 3H14V6C14 8.5 12 10 10 10C8 10 6 8.5 6 6V3Z" stroke="currentColor" strokeWidth="1.2" />
      <path d="M6 4H3C3 6 4 7 6 7M14 4H17C17 6 16 7 14 7" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" />
      <path d="M10 10V13M7 16H13L12 13H8L7 16Z" stroke="currentColor" strokeWidth="1.2" strokeLinejoin="round" />
    </svg>
  )
}
